...
config = \
    {
        ...
        'scripts': ['bin/dbcAmplicons', 'scripts/python/convert2ReadTo4Read.py', 'scripts/python/preprocPair_with_inlineBC.py', 'scripts/python/splitReadsBySample.py', 'scripts/R/reduce_amplicons.R', 'scripts/R/reduce_amplicons2.R', 'scripts/dbcVersionReport.sh'],
        'name': 'dbcAmplicons',

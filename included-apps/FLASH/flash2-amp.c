...
"Usage: flash2-amp [OPTIONS] MATES_1.FASTQ MATES_2.FASTQ\n"
"       flash2-amp [OPTIONS] --interleaved-input (MATES.FASTQ | -)\n"
"       flash2-amp [OPTIONS] --tab-delimited-input (MATES.TAB | -)\n"
"\n"
"----------------------------------------------------------------------------\n"
"                                 DESCRIPTION                                \n"
"----------------------------------------------------------------------------\n"
...
"\n"
"  $ flash2-amp reads_1.fq reads_2.fq 2>&1 | tee flash.log\n"
"\n"
...
"\n"
"  -m, --min-overlap-outie=NUM   The minimum required overlap length between two\n"

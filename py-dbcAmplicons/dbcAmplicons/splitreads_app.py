...
class splitreadsApp:
    verbose = False
    evalPrimer = False
    def start(self, input_prefix, output_prefix, samplesFile, batchsize, uncompressed, output_unidentified, verbose):
        """
        ...
        try:
            ...
            if output_unidentified:
                self.run_out["Unidentified"] = IlluminaTwoReadOutput(os.path.join(output_prefix,'_UnidentifiedProject'),uncompressed)
